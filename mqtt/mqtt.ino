/* 2.8.2016 - overflo @ metalab.at
 * code for loungelights RGB strip
 * based on: https://eryk.io/2015/10/esp8266-based-wifi-rgb-controller-h801/
 * just some small changes for our setup.. 
 *
...
char mqtt_server[40] = "10.20.30.96";


//char mqtt_server[40] = "10.20.32.73";


char mqtt_port[6] = "1883";
//char blynk_token[33] = "YOUR_BLYNK_TOKEN";
//default custom static IP
char static_ip[16] = "10.20.30.95";
char static_gw[16] = "10.20.30.1";
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect("ESP8266Client","foo","bar")) 
    {
      
      
    //  client.connect("ESP8266Client","foo","bar");
    //  delay(1000);
